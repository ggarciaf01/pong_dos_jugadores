...
/**
 * Controla el funcionamiento del tablero
...
public class Tablero extends JPanel {
    ...
    /**
     * Llama a todos los métodos para dibujar los componentes en el tablero
     */
    @Override
    ...
    /**
     * Dibuja las raquetas y la pelota, además de la linea del medio
     * @param g
     */
    ...
    /**
     * Actualiza la posición de las raquetas y la pelota
     */
    private void update() {
    ...
    /**
     * Dibuja la puntuación de los jugadores en el tablero
     * @param g
     */
